package com.fishauction.customerservice.common.docs.infrastructure.config;
...
public class DocsConfig {
    ...
    public GroupedOpenApi externalOpenApi() {
        String[] paths = {"/api/v0/search"};
        return GroupedOpenApi.builder().group("internal").pathsToExclude(paths).build();
    }
